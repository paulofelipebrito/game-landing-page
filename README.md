...
<p style="display: flex; align-items: flex-start; justify-content: center;">
  <img alt="restaurant" title="#restaurant" src="./src/assets/demo.gif" > 
  <img alt="restaurant" title="#restaurant" src="./src/assets/demo1.gif" > 
...
1. Clone the repo
   ```sh
   git clone https://github.com/paulofelipebrito/restaurant-landing-page
   ```
...
Project Link: [https://github.com/paulofelipebrito/restaurant-landing-page](https://github.com/paulofelipebrito/restaurant-landing-page)

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## Acknowledgments

This project was developed with the following acknowledgments:
...
- ✔️ Fundamental CSS properties to master flex & grid
  
- ✔️ Fundamentals of the CSS BEM Model
  
- ✔️ From soft and pleasant animations to complex gradients
  
- ✔️ Perfectly placed media queries for satisfactory responsiveness covering almost devices
...
[deploy-url]: https://restaurant-demo-app.netlify.app
